...
func (d *General500Data) Render() (string, error) {
	return render("general/500.gohtml", 10*1024, d)
}
...
func (d *GeneralUnsupportedBrowserData) Render() (string, error) {
	return render("general/unsupported-browser.gohtml", 30*1024, d)
}
