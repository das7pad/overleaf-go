...
type PendingOperationWithCancel interface {
	PendingOperation
	Cancel()
}
...
func trackOperationWithCancel(ctx context.Context, fn func(ctx context.Context) error) PendingOperationWithCancel {
